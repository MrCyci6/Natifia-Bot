        ...
        if(client.config.owners.includes(interaction.user.id)) {
            ...
            try {
                ...
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({text: `© ${client.config.server.year} - ${client.config.server.name} » Total: ${bans.length} | by ${client.author}`, iconURL: client.user.displayAvatarURL({dynamic: true})})
