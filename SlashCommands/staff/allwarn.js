        ...
        if(client.config.owners.includes(interaction.user.id) || author.roles.cache.has(client.config.roles.staff)) {
            ...
            try {
                ...
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({text: `© ${client.config.server.year} - ${client.config.server.name} » Total: ${warns.length} | by ${client.author}`, iconURL: client.user.displayAvatarURL({dynamic: true})})
